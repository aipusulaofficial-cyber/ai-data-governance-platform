...
|---|---|---|
| Architecture | [ARCHITECTURE.md](../ARCHITECTURE.md) | Data contracts, policy checks, lineage and access decisions and system boundaries |
| ADR | [0002-production-hardening.md](../ADRs/0002-production-hardening.md) | Explicit design trade-offs and production boundaries |
| Contracts | [tests/test_governance.py](../tests/test_governance.py) | Contract-focused validation at the repository boundary |
