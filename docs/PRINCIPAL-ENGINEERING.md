...
## Core boundary
**Primary concern:** Data governance.

Define data contracts and policy checks at boundaries; separate governance rules from storage adapters; preserve lineage-relevant metadata; make access decisions explicit and auditable.
